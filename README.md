...
Предсказание вероятности того, что человек курит, по медицинским и антропометрическим признакам. Финальный пайплайн использует tree-based модели, Optuna, Confidence Learning и ансамблирование; лучший честный OOF ROC-AUC в ноутбуке - **0.8889**, public leaderboard score - **0.8880**.
